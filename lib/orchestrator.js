...
export class Orchestrator extends EventEmitter {
   ...
   */
  static TIER1_ALWAYS_ALLOW = ['Read', 'Glob', 'Grep', 'WebSearch', 'WebFetch'];
  static TIER2_WRITE_TOOLS = ['Write', 'Edit', 'Bash', 'NotebookEdit'];
  ...
  async *executeChatbotAgentStreaming(agent, agentPath, message, systemPrompt, context) {
    ...
    log.info('Streaming chat session', { sessionId: session.id, agentPath: effectivePath });
