...
describe('SessionManager', () => {
  ...
  describe('getSession', () => {
    ...
    test('returns existing session on second call', async () => {
      const session1 = await sessionManager.getSession('agents/test-agent.md');
      const session2 = await sessionManager.getSession('agents/test-agent.md');
...
`;
  ...
  describe('clearSession', () => {
    test('clears messages from session', async () => {
      ...
      const clearedSession = await sessionManager.getSession('agents/test-agent.md');
